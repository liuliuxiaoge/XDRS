...
def urlmap_factory(loader, global_conf, **local_conf):
    """
    提供了到xdrs.api.openstack.FaultWrapper的入口；
    ======================================================================================
    loader = <paste.deploy.loadwsgi.ConfigLoader object at 0x3abcd50>
    global_conf = {'__file__': '/etc/xdrs/api-paste.ini', 'here': '/etc/xdrs'}
    local_conf = {
...
class URLMap(paste.urlmap.URLMap):
    ...
    def __call__(self, environ, start_response):
        ...
        if app:
            environ['xdrs.best_content_type'] = mime_type
            return app(environ, start_response)
